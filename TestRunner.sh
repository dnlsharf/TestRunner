...
if ! which java >/dev/null 2>&1 ; then echo Java not installed; else echo JAVA installed;fi
if ! which mvn >/dev/null 2>&1 ; then echo Maven not installed; else echo MVN installed; fi
if ! which git >/dev/null 2>&1 ; then echo Git not installed; else echo GIT installed; fi
